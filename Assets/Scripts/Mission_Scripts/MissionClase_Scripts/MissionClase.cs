...
public class MissionClase : MissionFather
{
    ...
    void CreateStats()
    {
        ...
        if (preguntoDudas)
        {
            textoStats.text += "*Levantaste la mano para indicar al profesor que te quedaron dudas\n";
        }
        else
        {
            textoStats.text += "* No levantaste la mano cuando el profesor preguntó si alguien tenía dudas\n";
